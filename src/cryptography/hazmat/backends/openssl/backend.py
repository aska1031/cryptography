...
from cryptography.hazmat.backends.interfaces import (
    ...
    PEMSerializationBackend, RSABackend, ScryptBackend, X509Backend, QTESLABackend
)
...
from cryptography.hazmat.backends.openssl.qtesla import (
    _QTESLA
)
...
@utils.register_interface(QTESLABackend)
